/// Include libraries for the program
use anchor_lang::prelude::*;
use anchor_lang::solana_program::log::sol_log_compute_units;
use anchor_spl::token::{self, Token};
use std::mem::size_of;
// Declare program ID
declare_id!("FYgvX8oW4nEJZ7vyL9vTy4gj62jaoe3JF7PFQDP7jMuW");
...
pub mod tiktok_clone {
    ...
    pub fn approve(ctx: Context<CreateComment>) -> Result<()> {
        // Get video
        let video = &mut ctx.accounts.video;
    ...
    pub fn disapprove(ctx: Context<CreateComment>) -> Result<()> {
        // Get video
        let video = &mut ctx.accounts.video;
